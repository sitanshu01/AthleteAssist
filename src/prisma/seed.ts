...
async function main() {
  ...
  const basketballRules = [
    ...
    {
      title: "Out of Bounds",
      description: "The ball is out of play when it touches a boundary line or any object out of bounds."
    },
    {
      title: "Shot Clock",
      description: "Teams must attempt a shot that hits the rim within the shot clock period."
    },
    {
    ...
    },
    {
      ...
      description: "The offense must move the ball past half court within eight seconds."
    },
    {
      title: "Goaltending",
      description:
  ...
  const basketballExercises = [
    ...
    },
    {
      ...
      sports: ["basketball"],
      bodyPart: "hips",
      description: "Glute bridges to strengthen posterior chain and support explosive movements.",
    ...
    },
    {
      ...
      sports: ["basketball"],
      bodyPart: "legs",
      description: "Forward lunges to strengthen quads and glutes while training stability.",
    ...
    },
    {
      ...
      sports: ["basketball"],
      bodyPart: "hips",
      description: "Stretching hip flexors to improve stride length and reduce tightness.",
    ...
    },
    {
      ...
      sports: ["basketball"],
      bodyPart: "hips",
      description: "Lateral walks with band for glute med activation and lateral stability.",
  ...
  const basketballWarmups = [
    ...
    },
    {
      ...
      sports: ["basketball"],
      type: WarmupType.PRE,
      description: "Dynamic lunges across the court for hip and leg activation."
    },
    {
    ...
    },
    {
      ...
      sports: ["basketball"],
      type: WarmupType.POST,
      description: "Static hamstring stretch to reduce tightness after games."
    },
    {
      name: "Quad Stretch",
      sports: ["basketball"],
